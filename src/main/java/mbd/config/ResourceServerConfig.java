...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/usuario/actualizar/**","/api/usuario/password/lost/**","/api/clientes","/api/cantones/**","/api/provincias","/api/clientes/page/**","/api/hola", "/api/personas", "/api/uploads/img/**", "/images/**").permitAll().
